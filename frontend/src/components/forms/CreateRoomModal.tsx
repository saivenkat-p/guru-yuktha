...
import { X, BookOpen, FileText, Globe, Lock, Plus } from 'lucide-react';
      ...
      <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl border border-slate-100 overflow-hidden">
        ...
        <div className="bg-indigo-600 px-6 py-5 flex items-center justify-between text-white">
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              <h3 className="font-bold text-base">Create Learning Room</h3>
              <p className="text-[11px] text-indigo-100 font-medium">Establish a structured academic space</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. English Communication — 2026"
            ...
            <div className="grid grid-cols-2 gap-2.5">
              ...
              >
                ...
                <p className="text-[10px] text-slate-500 mt-1 leading-tight">
                  Only explicitly approved or invited learners can join and view content.
                </p>
              </button>
              ...
              >
                ...
                <p className="text-[10px] text-slate-500 mt-1 leading-tight">
                  Public resources can be discovered without automatically tracking learners.
                </p>
              </button>
            </div>
          </div>
